...
INSERT INTO tarjetas (id, usuario_id, numero_tarjeta, titular, fecha_expiracion, tipo, marca) VALUES
    ('11111111-1111-1111-1111-111111111111', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '4111-1111-1111-1111', 'CARLOS GARCIA',    '12/28', 'credito', 'visa'),
    ('22222222-2222-2222-2222-222222222222', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '5500-0000-0000-0004', 'CARLOS GARCIA',    '06/27', 'credito', 'mastercard'),
    ('33333333-3333-3333-3333-333333333333', 'b2c3d4e5-f6a7-8901-bcde-f12345678901', '4000-0000-0000-0002', 'MARIA LOPEZ',      '03/29', 'credito', 'visa'),
    ('44444444-4444-4444-4444-444444444444', 'c3d4e5f6-a7b8-9012-cdef-123456789012', '3400-0000-0000-009',  'JUAN MARTINEZ',    '09/26', 'credito', 'amex'),
    ('55555555-5555-5555-5555-555555555555', 'd4e5f6a7-b8c9-0123-defa-234567890123', '4111-1111-1111-1234', 'ANA RODRIGUEZ',    '01/30', 'debito',  'visa'),
    ('66666666-6666-6666-6666-666666666666', 'e5f6a7b8-c9d0-1234-efab-345678901234', '5500-0000-0000-1234', 'ROBERTO HERNANDEZ','11/27', 'credito', 'mastercard')
